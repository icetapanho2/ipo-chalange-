...
- **R-L — Prazos em risco (Gestão):** pedidos que vão falhar o prazo nas próximas 2 semanas, com a solução proposta: vaga livre no prazo → troca segura → antecipar → sessão/vaga extra. Ordenados pelo índice.
- **R-M — Sessão extra:** para N vagas extra num dia/hora, pré-visualiza quem ganha com elas (mesmas regras da vaga libertada) e diz quantas chegam; abrir cria as vagas e envia as ofertas.
- **R-N — Espera por estádio:** mediana de dias pedido → marcação e % dentro do prazo, por estádio.
- **R-O — Encaixes sugeridos (só sugestão):** por dia, faltas esperadas = taxa histórica do serviço × 3 se já faltou × 2 sem contacto digital; nada é marcado.
...
| **Sónia, Artur, Fátima, Olga, Diogo** (100114–100118) | as 5 ecografias de 24/09; só há uma vaga livre a 25/09; o Diogo tem revisão a 29/09 que depende da eco | técnico reporta avaria na Ecografia a 24/09 (1 dia); a administrativa aceita o plano; Diogo → enviar ao médico; Dra. Sofia adia para 01/10 | Sónia (MP, diagnóstico, 717) **25/09 10:40**; Artur (MP, 621) **28/09 11:00** fora do prazo (aviso); Fátima **28/09 12:00** + aviso 2.ª remarcação; Olga **01/10 11:40** (dia único); Diogo **sem vaga a tempo** → alerta → consulta **06/10 09:30**, eco **28/09 12:40** |
| Dra. Sofia (U02) | 7 consultas a 08/10 | Joana regista ausência (08/10, 1 dia) e aceita o plano | 1.º (MP, diagnóstico) **13/10 09:10**; restantes a 13/10 e 15/10, com a mesma médica |
